...
class servoManager:
    ...
    def update(self):
        ...
        if (self.param.isDCmotor == False):
            #self.servoControl(self.profGenMovement.sProf)        #not used as servo does the positioning itself. Adding another profile generator would create little stops which looks not very nice
            self.servoControl(self.profGenMovement.sSet)
        else:
    ...
    def dcMotorControl(self, vSet):
        ...
        ServoDriveBoard.set_pwm(int(self.param.directionChannel1), dutyCycleTicksBegin, dutyCycleTicksEnd)
        ...
        dutyCycleTicksEnd = int(0)
        ServoDriveBoard.set_pwm(int(self.param.directionChannel2), dutyCycleTicksBegin, dutyCycleTicksEnd)
...
class servoParameters:
    ...
    def __init__(self):
        ...
        self.directionChannel1 = 0
        self.directionChannel2 = 0
        self.sMin = 0.0
        self.sMax = 0.0
        self.vMax = 0.0
        self.aMax = 0.0
